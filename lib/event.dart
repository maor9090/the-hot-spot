...
class Event {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'openingTime': '${openingTime.hour.toString().padLeft(2, '0')}:${openingTime.minute.toString().padLeft(2, '0')}',
      'closingTime': '${closingTime.hour.toString().padLeft(2, '0')}:${closingTime.minute.toString().padLeft(2, '0')}',
      'rating': rating,
